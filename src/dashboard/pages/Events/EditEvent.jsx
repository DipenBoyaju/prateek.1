  ...
  return (
    <div>
      <div className="bg-white p-4 flex justify-between shadow md:mx-4 md:mt-4 rounded-md">
        <p className="font-semibold md:text-lg text-blue-600">Edit Event</p>
        <p className="text-xs md:text-sm text-zinc-800/90 flex items-center">Event <HiMiniSlash className="text-base" /> <span className="text-blue-500 ">Add Event</span></p>
      </div>
