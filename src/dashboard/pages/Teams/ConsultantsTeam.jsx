...
const ConsultantsTeam = () => {
  const [cardLayout, setCardLayout] = useState(true)
  const nav = useNavigate()
  const { data: team } = useTeamByDepartment('Consultants');

  return (
    <div>
      <div className="bg-white p-4 flex justify-between shadow rounded-md">
        <p className="text-sm text-zinc-800/90 flex items-center">Team <HiMiniSlash className="text-base" /> <span className="text-blue-500 ">Consultants</span></p>
        <div className="">
...
export default ConsultantsTeam